...
<?php
	startDownloadList();
		...
		addDownload("catpl-gp2x", "GP2X Daily Snapshot", "", "http://buildbot.scummvm.org/snapshots/trunk/gp2x-trunk-latest.tar.bz2");

		addDownload("catpl-iphone", "iPhone Daily Snapshot", "", "http://buildbot.scummvm.org/snapshots/trunk/iphone-trunk-latest.tar.bz2");

		addDownload("catpl-macos", "Mac OS X Intel Daily Snapshot", "", "http://buildbot.scummvm.org/snapshots/trunk/os_x_intel-trunk-latest.tar.bz2");
		addDownload("catpl-macos", "Mac OS X PPC Daily Snapshot", "", "http://buildbot.scummvm.org/snapshots/trunk/os_x_ppc-trunk-latest.tar.bz2");

		addDownload("catpl-psp", "PSP (PlayStation Portable) Daily Snapshot", "", "http://buildbot.scummvm.org/snapshots/trunk/psp-trunk-latest.tar.bz2");

		addDownload("catpl-wii", "Wii Daily Snapshot", "", "http://buildbot.scummvm.org/snapshots/trunk/wii-trunk-latest.tar.bz2");
