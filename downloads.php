...
?>
  <div class="par-item">
    <div class="par-head">
       Downloads for ScummVM <span style="color: #aaaaaa;">version 0.8.1</span>
    </div>
...
<table border=0>
<?php
  html_nav_item("#stable", "0.8.1 Release binaries");
  html_nav_item("#source", "0.8.1 Source Code");
...
<td>
	  ...
	  <a href="http://cvs.sourceforge.net/viewcvs.py/scummvm/scummvm/README?rev=release-0-8-1">README</a>
	...
	<UL>
		<LI>The latest STABLE release of ScummVM is 0.8.1, and can be downloaded below
	...
	<a name="stable"></a>
	<br/>
    <?php html_subhead_start("0.8.1 Release binaries"); ?>

    <div class="par-subhead-content">

	<p>For a list of changes since the previous version, <a href="http://sourceforge.net/project/shownotes.php?release_id=388756">read the release notes</a>.
	<BR>
	0.8.1 should be directly apt-get'able from Debian unstable (sid).
	</p>

	<table>
	  <tr><td class='cat-bullet'><img src='images/catpl-windows.png' alt="" /></td><td class='cat-link'><a href="http://prdownloads.sourceforge.net/scummvm/scummvm-0.8.1-win32.exe?download"><b>Windows Installer</b></a> <font class='cat-count'>(1.5M Win32 .exe)</font></td></tr>
	  <tr><td class='cat-bullet'><img src='images/catpl-windows.png' alt="" /></td><td class='cat-link'><a href="http://prdownloads.sourceforge.net/scummvm/scummvm-0.8.1-win32.zip?download">Windows zipfile</a> <font class='cat-count'>(1.6M zipfile)</font></td></tr>
...
-->
	  ...
	  <tr><td class='cat-bullet'><img src='images/catpl-fedora.png' alt="" /></td><td class='cat-link'><a href="http://prdownloads.sourceforge.net/scummvm/scummvm-0.8.1-1_FC4.i386.rpm?download">Fedora Core 4 package</a> <font class='cat-count'>(1.4M RPM)</font></td></tr>
	  <tr><td class='cat-bullet'><img src='images/catpl-fedora.png' alt="" /></td><td class='cat-link'><a href="http://prdownloads.sourceforge.net/scummvm/scummvm-0.8.1-1_FC2.i386.rpm?download">Fedora Core 2 package</a> <font class='cat-count'>(1.6M RPM)</font></td></tr>

	  <tr><td class='cat-bullet'><img src='images/catpl-debian.png' alt="" /></td><td class='cat-link'><a href="http://prdownloads.sourceforge.net/scummvm/scummvm_0.8.1-0.sarge.1_i386.deb?download">Debian Stable (sarge) package</a> <font class='cat-count'>(1.4M .deb)</font></td></tr>

	  <tr><td class='cat-bullet'><img src='images/catpl-slackware.png' alt="" /></td><td class='cat-link'><a href="http://prdownloads.sourceforge.net/scummvm/scummvm-0.8.1_slack-i486-1.tgz?download">SlackWare package</a> <font class='cat-count'>(1.5M .tgz)</font></td></tr>
...
-->
	  ...
	  <tr><td class='cat-bullet'><img src='images/catpl-macos.png' alt="" /></td><td class='cat-link'><a href="http://prdownloads.sourceforge.net/scummvm/scummvm-0.8.1-macosx.dmg?download">Mac OS X Disk Image</a> <font class='cat-count'>(2.2M disk image)</font></td></tr>

	  <tr><td class='cat-bullet'><img src='images/catpl-os2.png' alt="" /></td><td class='cat-link'><a href="http://prdownloads.sourceforge.net/scummvm/scummvm-0.8.1-os2.zip?download">OS/2 package</a> <font class='cat-count'>(2.0M .zip)</font></td></tr>

	  <tr><td class='cat-bullet'><img src='images/catpl-ps2.png' alt="" /></td><td class='cat-link'><a href="http://prdownloads.sourceforge.net/scummvm/scummvm-0.8.1-ps2.zip?download">PS2 package</a> <font class='cat-count'>(2.0M .zip)</font></td></tr>

	  <tr><td class='cat-bullet'><img src='images/catpl-psp.png' alt="" /></td><td class='cat-link'><a href="http://prdownloads.sourceforge.net/scummvm/scummvm-0.8.1-psp.zip?download">PSP package</a> <font class='cat-count'>(3.3M .zip)</font></td></tr>

	  <tr><td class='cat-bullet'><img src='images/catpl-symbian.png' alt="" /></td><td class='cat-link'><a href="http://prdownloads.sourceforge.net/scummvm/scummvm-0.8.1-s60-v1.sis?download">Symbian S60 version 1 binary</a> <font class='cat-count'>(1.1M .sis)</font></td></tr>
	  <tr><td class='cat-bullet'><img src='images/catpl-symbian.png' alt="" /></td><td class='cat-link'><a href="http://prdownloads.sourceforge.net/scummvm/scummvm-0.8.1-s60-v2.sis?download">Symbian S60 version 2 binary</a> <font class='cat-count'>(1.1M .sis)</font></td></tr>
	  <tr><td class='cat-bullet'><img src='images/catpl-symbian.png' alt="" /></td><td class='cat-link'><a href="http://prdownloads.sourceforge.net/scummvm/scummvm-0.8.1-s80.sis?download">Symbian S80 binary</a> <font class='cat-count'>(1.1M .sis)</font></td></tr>
	  <tr><td class='cat-bullet'><img src='images/catpl-symbian.png' alt="" /></td><td class='cat-link'><a href="http://prdownloads.sourceforge.net/scummvm/scummvm-0.8.1-s90.sis?download">Symbian S90 binary</a> <font class='cat-count'>(1.1M .sis)</font></td></tr>
	  <tr><td class='cat-bullet'><img src='images/catpl-symbian.png' alt="" /></td><td class='cat-link'><a href="http://prdownloads.sourceforge.net/scummvm/scummvm-0.8.1-uiq2.sis?download">Symbian UIQ 2 binary</a> <font class='cat-count'>(1.1M .sis)</font></td></tr>
...
-->
	  ...
	  <tr><td class='cat-bullet'><img src='images/catpl-wince.png' alt="" /></td><td class='cat-link'><a href="http://prdownloads.sourceforge.net/scummvm/scummvm-0.8.1-WinCE2002.zip?download">PocketPC 2002 ARM package</a> <font class='cat-count'>(1.3M zipfile)</font></td></tr>

	  <tr><td class='cat-bullet'><img src='images/catpl-wince.png' alt="" /></td><td class='cat-link'><a href="http://prdownloads.sourceforge.net/scummvm/scummvm-0.8.1-WinMobileRecent.zip?download">Windows Mobile 5 ARM package</a> for PocketPC 2003, PocketPC 2003 SE,
...
-->
    ...
    <a name="source"></a>
    <?php html_subhead_start("0.8.1 Source Code"); ?>

    <div class="par-subhead-content">
	<table>
	  <tr><td class='cat-bullet'><img src='images/catpl-cpp.png' alt="" /></td><td class='cat-link'><a href="http://prdownloads.sourceforge.net/scummvm/scummvm-0.8.1.tar.bz2?download">ScummVM - Source .tar.bz2</a> <font class='cat-count'>(2.5M)</font></td></tr>
	  <tr><td class='cat-bullet'><img src='images/catpl-cpp.png' alt="" /></td><td class='cat-link'><a href="http://prdownloads.sourceforge.net/scummvm/scummvm-0.8.1.tar.gz?download">ScummVM - Source .tar.gz</a> <font class='cat-count'>(3.1M)</font></td></tr>
	  <tr><td class='cat-bullet'><img src='images/catpl-cpp.png' alt="" /></td><td class='cat-link'><a href="http://prdownloads.sourceforge.net/scummvm/scummvm-0.8.1.zip?download">ScummVM - Source .zip</a> <font class='cat-count'>(3.9M)</font></td></tr>
	  <tr><td class='cat-bullet'><img src='images/catpl-cpp.png' alt="" /></td><td class='cat-link'><a href="http://prdownloads.sourceforge.net/scummvm/scummvm-0.8.1-1.src.rpm?download">ScummVM - Source RPM</a> <font class='cat-count'>(3.3M RPM)</font></td></tr>
	</table>
...
-->
  ...
  <div class="par-item">
	...
	<table>
	  ...
	  <tr><td class='cat-bullet'><img src='images/cat-sky.png' alt="" /></td><td class='cat-link'><a href="http://prdownloads.sourceforge.net/scummvm/bass-cd-1.2.zip?download">Beneath a Steel Sky, Freeware CD Version [main site]</a> <a href="http://scummvm.edoras-art.de/bass-cd-1.2.zip">[mirror]</a> <font class='cat-count'>(67M)</font></td></tr>
