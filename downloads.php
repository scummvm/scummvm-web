...
-->
	  ...
	  <tr><td class='cat-bullet'><img src='images/catpl-debian.png' alt="" /></td><td class='cat-link'><a href="/downloads/scummvm_opie_svn_arm.ipk">Familiar SDL-Opie Linux build for iPAQ h1915 and MyPal 716</a> <font class='cat-count'> (infrequently from Subversion trunk, <? echo intval(filesize("downloads/scummvm_opie_svn_arm.ipk")/1024) ?>K zip file, last update: <? echo date("F j, Y, g:i a",filemtime("downloads/scummvm_opie_svn_arm.ipk")); ?>)</font></td></tr>
