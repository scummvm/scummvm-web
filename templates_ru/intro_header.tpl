		...
		<div class="rbcontent">
			<div class="rbwrapper">
				...
				<p>
					...
					(в том числе игры про <i>Рыбку Фредди</i> и <i>Бип-бипа</i>),
					а также множество других игр.
				<p>
					Вы можете найти полный список всех поддерживаемых игр, с градацией
					того, насколько они хорошо поддерживаются, на
					<a href="compatibility/">странице совместимости</a>.
					ScummVM активно развивается, так что заходите почаще.
					Среди систем, на которых теперь можно поиграть в эти игры есть: Windows, Linux, Mac OS X,
